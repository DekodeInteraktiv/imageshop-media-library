	...
	class ISML_Onboarding {
		...
		public function __construct() {
			...
			if (!$onboarding_completed) {
				...
				add_action('admin_enqueue_scripts', [$this, 'onboarding_styles']);
				add_action('rest_api_init', [$this, 'onboarding_rest_endpoints']);
			}
		}
		...
		public function onboarding_rest_endpoints() {
			register_rest_route(
				...
				[
					'methods'             => 'POST',
					'callback'            => [$this, 'rest_test_token'],
					'permission_callback' => [$this, 'user_can_setup_plugin'],
				]
			);
			...
			register_rest_route(
				...
				[
					'methods'             => 'GET',
					'callback'            => [$this, 'rest_get_interfaces'],
					'permission_callback' => [$this, 'user_can_setup_plugin'],
				]
			);
			...
			register_rest_route(
				...
				[
					'methods'             => 'POST',
					'callback'            => [$this, 'rest_set_interface'],
					'permission_callback' => [$this, 'user_can_setup_plugin'],
				]
			);
		...
		public function onboarding_styles() {
			...
			wp_enqueue_style('imageshop-onboarding', plugins_url('build/onboarding.css', ISML_PLUGIN_BASE_NAME), [], $asset['version']);
			wp_enqueue_script(
				'imageshop-onboarding', plugins_url('build/onboarding.js', ISML_PLUGIN_BASE_NAME), $asset['dependencies'], $asset['version'], true
			);
		}
